...
public class IceControllingAttribute
    extends Attribute
{
    /**
     * The length of the data contained in this attribute
     */
    private static final char DATA_LENGTH_ICE_CONTROLLING = 8;
     ...
     */
    protected IceControllingAttribute()
    {
        super(ICE_CONTROLLING);
    }
    ...
    void decodeAttributeBody(byte[] attributeValue, char offset, char length)
        ...
        // initializing the byte arrays which holds the 64 bit value after decoding
    ...
    public byte[] encode() {
        ...
        byte[] binValue = new byte[HEADER_LENGTH + DATA_LENGTH_ICE_CONTROLLING];
        ...
        // Length
        binValue[2] = (byte)(DATA_LENGTH_ICE_CONTROLLING>>8);
        binValue[3] = (byte)(DATA_LENGTH_ICE_CONTROLLING&0x00FF);
    ...
    {
        if(!(obj instanceof IceControllingAttribute)
            || obj == null)
            return false;
        ...
        IceControllingAttribute iceControllingAtt = (IceControllingAttribute)obj;
        if(iceControllingAtt.getAttributeType() != getAttributeType()
            || iceControllingAtt.getDataLength() != DATA_LENGTH_ICE_CONTROLLING
            || !(Arrays.equals(getTieBreaker(),
                            iceControllingAtt.getTieBreaker())))
            return false;
    ...
    {
        return DATA_LENGTH_ICE_CONTROLLING;
    }
