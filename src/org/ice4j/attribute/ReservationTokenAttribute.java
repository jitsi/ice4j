...
extends Attribute
{
  ...
  /**
   * Returns a (cloned) byte array containg the reservationToken value of the reservationToken
   * attribute.
  ...
  /**
   * Copies the specified binary array into the the reservationToken value of the reservationToken
   * attribute.
